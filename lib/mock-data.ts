...
const employees: Employee[] = [
  ...
  },
  {
    ...
    idCard: "074199008765",
    phone: "0978112233",
    email: "linh.do@vsip-supply.vn",
    projectId: "prj-vsip",
    projectCode: "VSIP-BD",
    department: "Kho Vận & Logistics",
    position: "Thủ kho nguyên liệu",
    joinDate: "2024-02-15",
    status: "active",
  },
  {
  ...
  },
  {
    ...
    idCard: "019099005544",
    phone: "0912889900",
    email: "hai.pham@sevt-support.vn",
    projectId: "prj-sevt",
    projectCode: "SEVT-TN",
    department: "Phòng Sản Xuất Linh Kiện",
    position: "Kỹ thuật viên thực tập",
    joinDate: "2026-08-01",
    status: "probation",
  },
  {
    ...
    idCard: "019194002211",
    phone: "0967334455",
    email: "tuyet.dang@sevt-support.vn",
    projectId: "prj-sevt",
    projectCode: "SEVT-TN",
    department: "Phòng Sản Xuất Linh Kiện",
    position: "KCS linh kiện",
    joinDate: "2022-11-20",
    status: "resigned",
  },
  {
    ...
    idCard: "027096005566",
    phone: "0988776611",
    email: "bao.phan@foxconn-partner.vn",
  ...
  },
  {
    ...
    idCard: "027198007788",
    phone: "0909887766",
    email: "ngan.trinh@foxconn-partner.vn",
    projectId: "prj-foxconn",
    projectCode: "FXC-BN",
    department: "Phòng Kế toán kho",
    position: "Kế toán kho vật tư",
    joinDate: "2022-10-15",
    status: "active",
  },
  {
    ...
    idCard: "027099003322",
    phone: "0981223344",
    email: "hoang.truong@foxconn-partner.vn",
    projectId: "prj-foxconn",
    projectCode: "FXC-BN",
    department: "Xưởng Đóng Gói",
    position: "Công nhân thử việc",
  ...
  },
  {
    id: "emp-cpl-001",
    code: "NV-CPL-001",
    name: "Đặng Đình Trọng",
    idCard: "026095009900",
    phone: "0934556677",
    email: "trong.dang@compal-vendor.vn",
    projectId: "prj-compal",
    projectCode: "CPL-VP",
    department: "Xưởng Bo Mạch",
    position: "Công nhân hàn bo",
    joinDate: "2023-07-20",
    status: "active",
  },
  {
    ...
    idCard: "031093006677",
    phone: "0915667788",
    email: "huy.luong@lg-supplier.vn",
    projectId: "prj-lg",
    projectCode: "LG-HP",
    department: "Tổ Module Màn Hình",
    position: "Trưởng nhóm lắp ráp",
    joinDate: "2022-04-10",
    status: "active",
  },
];
