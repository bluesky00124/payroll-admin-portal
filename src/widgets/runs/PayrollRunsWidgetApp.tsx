...
export interface PayrollRunsWidgetConfig {
...
function RunsRouterView() {
  ...
  if (
    ...
    return <PayrollDetailPage payrollId={pId} />;
  }

  return <PayrollWorkspacePage />;
}

export function PayrollRunsWidgetApp({ config }: { config: PayrollRunsWidgetConfig }) {
...
export default PayrollRunsWidgetApp;
